...
export const Route = createFileRoute('/demand/$id/')({
    ...
    loader: async ({ params, deps }) => {
        const { ShowFigures, ShowDebug, SRType, Algorithm, Beta, Prices, CompoundSuppression } =
            await deps;
...
function RouteComponent() {
    const { ID, SRType, ShowDebug, ShowFigures, Algorithm, Beta, Prices, CompoundSuppression } =
        Route.useLoaderData();
