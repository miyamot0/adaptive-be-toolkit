...
export default function HomePage({ ShowHeader = true, ShowFooter = true, error }: Props) {
    return <PageWrapper ShowHeader={ShowHeader} ShowFooter={ShowFooter}>
        <main className="">
            ...
            <section className="flex flex-col gap-4 mt-8">
                ...
                <Button variant="outline" asChild>
                    <Link className="text-sm font-medium text-primary hover:underline"
                        ...
                        params={{ id: '12345678', method: 'adjusting-amount-ascending' }}
                        search={{
                            debug: 'true',
                            figures: 'true',
                            reinforcer: 'Dollars',
